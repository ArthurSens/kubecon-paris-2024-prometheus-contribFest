...
command -v kind >/dev/null 2>&1 || { echo 'Please install kind (go install sigs.k8s.io/kind@v0.22.0) or follow https://kind.sigs.k8s.io/docs/user/quick-start/'; exit 1; }
